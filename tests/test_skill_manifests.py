...
# The skills that ship with `user-invocable: true`. 12 user-facing skills +
...
USER_INVOCABLE_SKILLS = {
    "pbg-catalog", "pbg-dashboard", "pbg-expert", "pbg-explore", "pbg-init",
    "pbg-investigation", "pbg-report", "pbg-run", "pbg-server", "pbg-status",
    "pbg-study", "pbg-viz", "pbg-workspace",
}
