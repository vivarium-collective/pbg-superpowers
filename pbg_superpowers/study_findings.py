...
:mod:`pbg_superpowers.expert_search`, and append the curated entries
...
# ---------------------------------------------------------------------------
# CLI entry: python -m pbg_superpowers.study_findings <slug> [--auto] [--dry-run]
# ---------------------------------------------------------------------------
...
def main(argv: list[str] | None = None) -> int:
    ...
    p = argparse.ArgumentParser(
        prog="python -m pbg_superpowers.study_findings",
