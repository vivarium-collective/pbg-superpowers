...
``pbg_superpowers/catalog/modules.json`` in place):

    python3 -m pbg_superpowers.catalog.sync_catalog
...
``pbg_superpowers.catalog.load_registry``. A removed entry simply stops
