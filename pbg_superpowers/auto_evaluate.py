...
runner reuses :func:`pbg_superpowers.study_evaluator.evaluate_study` against a
...
from . import study_io  # noqa: F401  (kept for the documented study_io/study_outcomes seam)
...
def _evaluator_test_runner(
    ...
    """
    from .study_evaluator import _resolve_run_store, evaluate_study  # noqa: PLC0415
