...
[ -n "$CID" ] || { echo "Usage: /pbg-run <composite-id> [--steps N] [--emit p1,p2,...]"; exit 1; }
...
'
echo
echo "Next: /pbg-explore $CID  to inspect in the dashboard"
```

## Example

```text
/pbg-run pbg_chromosome_rep1.composites.dnaa-binding --steps 10 --emit stores/dnaa
```
...
Next: /pbg-explore pbg_chromosome_rep1.composites.dnaa-binding  to inspect in the dashboard
```
